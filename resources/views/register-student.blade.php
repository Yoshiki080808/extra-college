        ...
        <form action="{{ route('store.student') }}" method="POST">
          ...
          <div class="overflow-hidden shadow sm:rounded-md">
            ...
            <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
              <button href="{{ route('store.student') }}" type="submit" class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">申し込む</button>
            </div>
          </div>
        </form>
      </div>
