...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
  ...
  <div class="container mx-auto px-6 py-8">
    <div>
        <h3 class="text-3xl font-medium text-gray-700">現在のステータス</h3>
        <div class="mt-4">
            ...
            <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
              <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                ...
                <div class="mx-5">
                  ...
                  <div class="text-gray-500">お気に入りインターンシップ</div>
                </div>
              </div>
            </div>
            <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
              <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                ...
                <div class="mx-5">
                  ...
                  <div class="text-gray-500">申込中インターンシップ</div>
                </div>
              </div>
            </div>
            <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
              <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                ...
                <div class="mx-5">
                  ...
                  <div class="text-gray-500">確定したインターンシップ</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
            <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
              <table class="min-w-full">
                <thead>
                <tr>
                    <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50"> インターンシップ予定企業名 </th>
                ...
                <tbody class="bg-white">
                  <tr>
                    <td class="px-6 py-4 border-b border-gray-200 whitespace-nowrap">
                      <div class="flex items-center">
                        <div class="flex-shrink-0 w-10 h-10">
                          <img class="w-10 h-10 rounded-full" src="https://cdn.pixabay.com/photo/2016/04/20/08/21/entrepreneur-1340649_960_720.jpg" alt="image">
                        </div>
                        <div class="ml-4">
                          <div class="text-sm font-medium leading-5 text-gray-900">Kaneko Consulting</div>
                          <div class="text-sm leading-5 text-gray-500">kaneko@example.com</div>
                        </div>
                      </div>
                    </td>
                    <td class="px-6 py-4 border-b border-gray-200 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 text-sm font-medium leading-5 text-right border-b border-gray-200 whitespace-nowrap">
                      <a href="curriculum" class="text-indigo-600 hover:text-indigo-900">詳しい内容</a>
                    </td>
                  </tr>
                  <tr>
                    <td class="px-6 py-4 border-b border-gray-200 whitespace-nowrap">
